...
class App extends Component {
  ...
  return (
        ...
        <Layout>
          <Header className="header-color" title={<Link to="/" style={{textDecoration:"none", color:"#fff"}}>Tayment</Link>} scroll>
            <Navigation>
          ...
          <Drawer title={<Link to="/" style={{textDecoration:"none", color:"#000"}}>Tayment</Link>}>
            <Navigation>
              <Link to="/">Acceuil</Link>
              <Link to="/commande">Commande</Link>
              <Link to="/inventaire">Inventaire</Link>
